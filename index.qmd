...
Over 12 weeks, you progress from understanding basic computational concepts to architecting systems:

**Weeks 1--4** (Computational Thinking): Input/output, storage, decisions, patterns. You learn to think about problems before you write a single line of code.

**Weeks 5--8** (Building Systems): Functions, data structures, file handling, integration. You learn to build programs from smaller, reusable pieces.

**Weeks 9--12** (Real-World Programming): Data processing, APIs, interaction, architecture. You learn to build programs that do useful things in the real world.
...
This book is the first in a Python learning path:

1. **Think Python, Direct AI** (this book) — computational thinking for absolute beginners
2. **Code Python, Consult AI** — focused Python fundamentals with AI integration
3. **Ship Python, Orchestrate AI** — professional Python development practices and tooling

The methodology behind all three comes from *Conversation, Not Delegation: How to Think With AI, Not Just Use It*, which covers the full framework for working with AI across any discipline.
