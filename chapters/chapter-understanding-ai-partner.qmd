...
### Part II: AI as Implementation Assistant
```text
Example prompts:
...
There is a popular approach called "vibe coding" — prompting AI until something works, without worrying too much about understanding the code. For quick experiments and throwaway scripts, it can be genuinely useful. If you just need a one-off script to rename some files, vibe coding is fine.
...
::: {.callout-important title="The real skill"}
...
There is an economic version of this, and it is worth saying plainly. As AI gets better at writing code for everyone, "AI can write the code" stops being an advantage — it can write your competitor's code just as well, the same way. What it cannot produce is the variation: your judgement about which problem matters, your taste for the solution that fits, your ability to spot the answer that is confidently wrong. That is the only edge that does not commoditise, and it is exactly what this book builds. *Conversation, Not Delegation* makes the full argument.
